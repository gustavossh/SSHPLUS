...
# - Execulta instalador
[[ -e ssh-plus ]] && rm ssh-plus
wget painel-raio-vpn-app.shop/scripts/${arch}/ssh-plus
chmod +x ssh-plus
[[ $(systemctl | grep -ic fuse) != '0' ]] && ./ssh-plus || ./ssh-plus --appimage-extract-and-run
rm ssh-plus > /dev/null 2>&1